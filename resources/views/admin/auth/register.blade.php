        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-8 text-center">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ route('admin.register.store') }}">
                        ...
                        <div class="form-group">
                            <input id="password" type="text" class="form-control input-sm chat-input @error('password') is-invalid @enderror" name="password" value="{{ old('password') }}" placeholder="Password" autocomplete="password" autofocus>
                        ...
                        <div class="form-group">
                            <input id="cpassword" type="password" class="form-control input-sm chat-input" name="cpassword" placeholder="Confirm Password" autocomplete="new-password">
