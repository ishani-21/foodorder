            ...
            <div class="col-md-offset-3 col-md-6 text-center">
                <div class="form-login">
                    <div class="form-group">
                        <a href="{{route('google')}}" class="btn btn-md btn-danger"><i class="fab fa-google"></i> Login vai Google</a>
                    </div>
                    <div class="form-group">
                        <a href="{{route('facebook')}}" class="btn btn-md btn-primary"><i class="fab fa-facebook"></i> Login vai Facebook</a>
                    </div>
                    <h3>Login</h3>
                    ...
                    <h4 class="text-center">Don't have an account? <a href="register">Sign Up</a>.</h4>
                    <h4 class="text-center">Forgot password? <a href="{{route('show_forgot_password')}}">Click here</a>.</h4>
                </div>
            </div>
        </div>
    </div>
